...
var forgotView = '<table id="forgotView" style="height: 100%; width: 100%; font-family: helvetica, sans-serif; background: radial-gradient(at top right, rgba(255, 255, 0, 0.8), #006bff, rgba(3, 47, 167, 0.83), #009970, #148000)">
		<tr style="height: 33%">
...
var headerView = '<table id="headerView" style="height: 15%; width: 100%; background: radial-gradient(at top right, rgba(255, 255, 0, 0.8), #006bff, rgba(3, 47, 167, 0.83), #009970, #148000)">
			<tr style="height: 100%"><td style="text-align: center; vertical-align: middle; color: white">My Bible Q & A</td><tr>
		</table>';

var loginView = '<table id="loginView" style="height: 100%; width: 100%; font-family: helvetica, sans-serif; background: radial-gradient(at top right, rgba(255, 255, 0, 0.8), #006bff, rgba(3, 47, 167, 0.83), #009970, #148000);">
		<tr style="height: 33%">
			<td style="width: 25%"></td>
			<td style="width: 50%; text-align: center; vertical-align: bottom">
		...
		<tr style="height: 33%">
			<td></td>
			<td style="text-align: center; font-size: 0.8rem; vertical-align: top;"><span id="loginResponse"><a href="" style="color:#f1f4b2">Did you forgot your Username or Password?</a></span></td>
			<td></td>
		</tr>
	</table>';

var queueView = '<table id="queueView" style="height: 100%">
			<tr style="height: 25%">
			</tr>
			<tr style="height: 5%">
