...
public class AWSInstrumentedTest {
    ...
    public void setUp() throws Exception {
        AwsS3Manager.initialize(InstrumentationRegistry.getTargetContext());
    ...
    public void downloadInvalidZipFile() throws Exception {
        ...
        AwsS3Manager.findTest().downloadZipFile("shortsands", "hello1", file4, listener4);
    ...
    public void uploadAnalytics() throws Exception {
        ...
        AwsS3Manager.findTest().uploadAnalytics("sessionId", "2017-01-01T12:12:12", "TestV1", json.toString(), listener1);
        Thread.sleep(10000);
