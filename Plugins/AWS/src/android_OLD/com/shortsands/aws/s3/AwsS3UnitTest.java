...
public class AwsS3UnitTest {
    ...
    public void testPresignedURL() {
        AwsS3 s3 = new AwsS3(this.context);
    ...
    public void testDownloadFile() {
        ...
        DownloadFileListener listener1 = new DownloadFileListener(file1);
        s3.downloadFile("shortsands", "EmmaFirstLostTooth.mp3", listener1);
        ...
        DownloadFileListener listener2 = new DownloadFileListener(file2);
        s3.downloadFile("shortsands", "EmmaFirstLostTooth.mp3", listener2);
        ...
        DownloadFileListener listener3 = new DownloadFileListener(file3);
        s3.downloadFile("shortsands", "notthere", listener3);
        Log.d(TAG, "Expect Error: The specified key does not exist.");
    }
    ...
    public void testDownloadZipFile() {
        ...
        DownloadZipFileListener listener1 = new DownloadZipFileListener(file1);
        s3.downloadZipFile("shortsands", "WEB.db.zip", listener1);
        ...
        DownloadZipFileListener listener2 = new DownloadZipFileListener(file2);
        s3.downloadZipFile("shortsands", "WEB.db.zip", listener2);
        Log.d(TAG, "Expect Success: Success: /storage/emulated/0/Android/data/com.shortsands.aws_s3_android/cache/WEB.db");

        File file3 = new File(this.context.getExternalCacheDir(), "Whatever.mp3");
        DownloadZipFileListener listener3 = new DownloadZipFileListener(file3);
        s3.downloadZipFile("shortsands", "notthere", listener3);
        Log.d(TAG, "Expect Error: The specified key does not exist.");
        ...
        DownloadZipFileListener listener4 = new DownloadZipFileListener(file4);
        s3.downloadZipFile("shortsands", "hello1", listener4);
    ...
    public void testUploadAnalytics() {
        ...
        s3.uploadVideoAnalytics("1234512345", "2017-05-23T23:22:00", "{message: more}", listener1);
    ...
    public void testUploadFile() {
        ...
        UploadFileListener listener1 = new UploadFileListener(file1);
        s3.uploadFile("shortsands", "upload_test_1", listener1);
        Log.d(TAG, "Expect:  Success: /data/user/0/com.shortsands.aws_s3_android/files/EmmaLooseTooth.mp3");

        // Attempt to upload a non-existent file
        File file2 = new File(this.context.getFilesDir(), "Not_There.mp3");
        UploadFileListener listener2 = new UploadFileListener(file2);
        s3.uploadFile("shortsands", "XXX_upload_test_1", listener2);
        Log.d(TAG, "Expect:  Success: /data/user/0/com.shortsands.aws_s3_android/files/EmmaLooseTooth.mp3");

        // Attempt to upload a non-existent bucket
        File file3 = new File(this.context.getFilesDir(), "EmmaLooseTooth.mp3");
        UploadFileListener listener3 = new UploadFileListener(file3);
        s3.uploadFile("notthere", "XXX_upload_test_1", listener3);
