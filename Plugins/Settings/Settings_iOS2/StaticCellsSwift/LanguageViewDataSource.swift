...
class LanguageViewDataSource : NSObject, UITableViewDataSource, UISearchResultsUpdating {
    
    var searchCell: VersionSearchCell?
    let dataModel = LanguageModel()
    ...
    func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        switch section {
        case 0: return "My Languages"
        case 1: return "Other Languages"
        default: return nil
        }
    }
