...
'Arabic: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/ARBERV/ARBERV', 
...
'Arabic: Van Dyck Bible', null, 'text-%R-shortsands', 'text/ARBVDV/ARBVDV', 
...
'Awadi: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/AWAERV/AWAERV', 
'%I_%O_%B_%C.html', 'dbp-prod', null, 'audio/AWAWTC/AWAWTCN2DA', 
null, null, null);

-- currently ERV-BEN
INSERT INTO Bible VALUES('ERV-BEN.db', 'ERV', 'ben', 'B', 'পবিত্র বাইবেল',
'Bengali: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/BENERV/BENERV', 
...
'Bulgarian: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/BULERV/BULERV', 
...
'Chinese: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/CMNERV/CMNERV', 
'%I_%O_%B_%C.html', 'dbp-prod', 'audio/CMNUNV/CHNUNVO2DA', 'audio/CMNUNV/CHNUNVN2DA', 
null, null, null); -- audio is different version

-- currently ERV-ENG
INSERT INTO Bible VALUES('ERV-ENG.db', 'ERV', 'eng', 'B', 'Easy to Read Bible',
'English: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/ENGERU/ENGERU', 
'%I_%O_%B_%C.html', 'dbp-prod', 'audio/ENGESV/ENGESVO2DA', 'audio/ENGESV/ENGESVN2DA', 
null, null, null); -- audio is different version

-- currently KJVPD
INSERT INTO Bible VALUES('KJVPD.db', 'KJV', 'eng', 'B', 'King James Version',
'English: King James Version', null, 'text-%R-shortsands', 'text/ENGKJV/ENGKJV', 
'%I_%O_%B_%C.html', 'dbp-prod', 'audio/ENGKJV/ENGKJVO2DA', 'audio/ENGKJV/ENGKJVN2DA', 
null, null, null);

-- currently WEB
INSERT INTO Bible VALUES('WEB.db', 'WEB', 'eng', 'B', 'World English Bible',
'English: World English Bible', null, 'text-%R-shortsands', 'text/ENGWEB/ENGWEB', 
...
'Hindi: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/HINERV/HINERV', 
...
'Croatian: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/HRVERV/HRVERV', 
'%I_%O_%B_%C.html', 'dbp-prod', null, null, 
null, null, null);

-- currently ERV-HUN
INSERT INTO Bible VALUES('ERV-HUN.db', 'ERV', 'hun', 'B', 'Biblia Egyszerű fordítás',
'Hungarian: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/HUNERV/HUNERV', 
...
'Russian: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/RUSWTC/RUSWTC', 
...
'Spanish: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/SPAWTC/SPNWTC', 
...
'Serbian: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/SRPERV/SRPERV', 
'%I_%O_%B_%C.html', 'dbp-prod', null, null, 
null, null, null);

-- currently ERV-TAM
INSERT INTO Bible VALUES('ERV-TAM.db', 'ERV', 'tam', 'B', 'பரிசுத்த பைபிள்',
'Tamil: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/TAMERV/TAMERV', 
...
'Thai: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/THAERV/THAERV', 
'%I_%O_%B_%C.html', 'dbp-prod', null, null, 
null, null, null);

-- currently ERV-UKR
INSERT INTO Bible VALUES('ERV-UKR.db', 'ERV', 'ukr', 'N', 'Новий Заповіт Сучасною Мовою',
'Ukrainian: Easy-to-Read Bible', null, 'text-%R-shortsands', 'text/UKRBLI/UKRERV', 
